...
goog.addDependency = function(a, b, c, d) {
    if (goog.DEPENDENCIES_ENABLED) {
        ...
        for (var g = 0; e = b[g]; g++) f.nameToPath[e] = a, f.pathIsModule[a] = "goog" == d.module;
...
Blockly.Comment.prototype.createEditor_ = function() {
    ...
    Blockly.bindEvent_(this.textarea_, "change", this, function(a) {
...
Blockly.Comment.prototype.setVisible = function(a) {
    if (a != this.isVisible())
        if (Blockly.Events.fire(new Blockly.Events.Ui(this.block_, "commentOpen", !a, a)), !this.block_.isEditable() && !this.textarea_ || goog.userAgent.IE) Blockly.Warning.prototype.setVisible.call(this, a);
            ...
            a ? (this.bubble_ = new Blockly.Bubble(this.block_.workspace, this.createEditor_(), this.block_.svgPath_, this.iconX_, this.iconY_, this.width_, this.height_), this.bubble_.registerResizeEvent(this, this.resizeBubble_),
...
Blockly.Connection.connect_ = function(a, b) {
...
Blockly.Connection.prototype.isConnectionAllowed = function(a, b) {
    ...
    if (a.type == Blockly.INPUT_VALUE && a.isConnected() && !a.targetBlock().isMovable() && !a.targetBlock().isShadow() || this.type == Blockly.PREVIOUS_STATEMENT && a.isConnected() &&
        !this.sourceBlock_.nextConnection) return !1;
    var c = a.getSourceBlock(),
        d = this.sourceBlock_;
    if (c && d) {
        do {
...
Blockly.ConnectionDB.prototype.searchForClosest = function(a, b, c, d) {
    ...
    c = null;
    d = b;
    for (var h, k = g - 1; 0 <= k && this.isInYRange_(k, a.y_, b);) h = this[k], a.isConnectionAllowed(h, d) && (c = h, d = h.distanceFrom(a)), k--;
    for (; g < this.length && this.isInYRange_(g, a.y_, b);) h = this[g], a.isConnectionAllowed(h, d) && (c = h, d = h.distanceFrom(a)), g++;
    a.x_ = f;
    a.y_ = e;
    return {
        connection: c,
...
Blockly.WorkspaceSvg.prototype.onMouseDown_ = function(a) {
    ...
    Blockly.isTargetInput_(a) || (Blockly.svgResize(this), Blockly.terminateDrag_(), Blockly.hideChaff(), a.target && a.target.nodeName && ("svg" == a.target.nodeName.toLowerCase() || a.target == this.svgBackground_) && Blockly.selected && !this.options.readOnly && Blockly.selected.unselect(), Blockly.isRightButton(a) ? this.showContextMenu_(a) : this.scrollbar && (this.isScrolling = !0, this.startDragMouseX = a.clientX, this.startDragMouseY =
        a.clientY, this.startDragMetrics = this.getMetrics(), this.startScrollX = this.scrollX, this.startScrollY = this.scrollY, "mouseup" in Blockly.bindEvent_.TOUCH_MAP && (Blockly.onTouchUpWrapper_ = Blockly.onTouchUpWrapper_ || [], Blockly.onTouchUpWrapper_ = Blockly.onTouchUpWrapper_.concat(Blockly.bindEvent_(document, "mouseup", null, Blockly.onMouseUp_))), Blockly.onMouseMoveWrapper_ = Blockly.onMouseMoveWrapper_ || [], Blockly.onMouseMoveWrapper_ = Blockly.onMouseMoveWrapper_.concat(Blockly.bindEvent_(document, "mousemove", null,
            Blockly.onMouseMove_))), a.stopPropagation())
};
...
Blockly.BlockSvg.prototype.onMouseDown_ = function(a) {
    if (!this.workspace.options.readOnly) {
        if (!this.isInFlyout)
            if (Blockly.setPageSelectable(!1), this.workspace.markFocused(), Blockly.svgResize(this.workspace), Blockly.terminateDrag_(), this.select(), Blockly.hideChaff(), this.workspace.recordDeleteAreas(), Blockly.isRightButton(a)) this.showContextMenu_(a);
...
Blockly.BlockSvg.prototype.onMouseUp_ = function(a) {
    ...
    Blockly.selected && Blockly.highlightedConnection_ ? (Blockly.localConnection_.connect(Blockly.highlightedConnection_), this.rendered && (Blockly.localConnection_.isSuperior() ? Blockly.highlightedConnection_ : Blockly.localConnection_).getSourceBlock().connectionUiEffect(), this.workspace.trashcan && this.workspace.trashcan.close()) :
        !this.getParent() && Blockly.selected.isDeletable() && this.workspace.isDeleteArea(a) && ((a = this.workspace.trashcan) && goog.Timer.callOnce(a.close, 100, a), Blockly.selected.dispose(!1, !0), Blockly.fireUiEvent(window, "resize"));
...
Blockly.BlockSvg.prototype.renderCompute_ = function(a) {
    ...
    for (var d = 0, e = 0, f = !1, g = !1, h = !1, k = void 0, l = this.getInputsInline() && !this.isCollapsed(), q = 0, m; m = b[q]; q++)
        if (m.isVisible()) {
            ...
            l || q != b.length - 1 ? !l && m.type == Blockly.INPUT_VALUE && b[q + 1] && b[q + 1].type == Blockly.NEXT_STATEMENT &&
            ...
            p.type != Blockly.BlockSvg.INLINE && (p.type == Blockly.NEXT_STATEMENT ? (g = !0, e = Math.max(e, m.fieldWidth)) :
                (p.type == Blockly.INPUT_VALUE ? f = !0 : p.type == Blockly.DUMMY_INPUT && (h = !0), d = Math.max(d, m.fieldWidth)))
        }
    for (a = 0; p = c[a]; a++)
...
Blockly.FieldDropdown.prototype.init = function(a) {
    this.fieldGroup_ || (this.arrow_ = Blockly.createSvgElement("tspan", {}, null), this.arrow_.appendChild(document.createTextNode(a.RTL ? Blockly.FieldDropdown.ARROW_CHAR + " " : " " + Blockly.FieldDropdown.ARROW_CHAR)), Blockly.FieldDropdown.superClass_.init.call(this, a), a = this.text_, this.text_ = null, this.setText(a))
};
...
Blockly.Flyout.prototype.init = function(a) {
    ...
    Array.prototype.push.apply(this.eventWrappers_, Blockly.bindEvent_(this.svgGroup_, "mousedown",
...
Blockly.Flyout.prototype.createBlockFunc_ = function(a) {
    ...
    return function(d) {
        if (!Blockly.isRightButton(d) && !a.disabled) {
            ...
            f.y += b.workspace_.scrollY / b.workspace_.scale -
                b.workspace_.scrollY;
            g = e.getSvgRoot();
...
Blockly.Toolbox.prototype.populate_ = function(a) {
    function b(a, f) {
        for (var g = null, h = 0, k; k = a.childNodes[h]; h++)
            if (k.tagName) switch (k.tagName.toUpperCase()) {
                case "CATEGORY":
                    ...
                    "true" == k.getAttribute("expanded") ? (g.blocks.length && c.setSelectedItem(g), g.setExpanded(!0)) :
                        g.setExpanded(!1);
                    g = k;
                    break;
                case "SEP":
...
Blockly.onKeyDown_ = function(a) {
    if (!Blockly.mainWorkspace.options.readOnly && !Blockly.isTargetInput_(a)) {
        ...
        if (27 == a.keyCode) Blockly.hideChaff();
            ...
            a.preventDefault()
        } else if (a.altKey || a.ctrlKey || a.metaKey) Blockly.selected && Blockly.selected.isDeletable() && Blockly.selected.isMovable() && (67 == a.keyCode ? (Blockly.hideChaff(), Blockly.copy_(Blockly.selected)) : 88 == a.keyCode && (Blockly.copy_(Blockly.selected),
            b = !0)), 86 == a.keyCode ? Blockly.clipboardXml_ && Blockly.clipboardSource_.paste(Blockly.clipboardXml_) : 90 == a.keyCode && (Blockly.hideChaff(), Blockly.mainWorkspace.undo(a.shiftKey));
...
Blockly.getMainWorkspaceMetrics_ = function() {
    ...
    e = 0;
    !this.RTL && this.toolbox_ && (e = this.toolbox_.width);
    return {
        viewHeight: a.height,
        viewWidth: a.width,
        contentHeight: d - f,
